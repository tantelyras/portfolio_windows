...
function setLang(lang){
  ...
  const T = {
    ...
    fr: {
      ...
      'about-role':'Telecommunications Engineer · Master 2','about-avail':'Available for freelance',
      'about-bio-lbl':'Bio','about-bio-txt':'Excellent problem-solving skills avec capacité de performer en équipe dans un environnement dynamique. 5 ans de formation en Télécommunications, 2 ans d'expérience, 14 projets réalisés et 5 certificats obtenus.',
      ...
      'p1-name':'Applications Web & Mobile','p1-desc':'14 web/mobile pages and applications built individually and in teams.',
      'p2-name':'Projets Systèmes & Réseaux','p2-desc':'Network administration, Linux server configuration and IT infrastructure.',
      'p3-name':'Data Analytics & Visualisation','p3-desc':'Data analysis, dashboards and visualizations for decision support.',
      'p4-name':'Machine Learning Projects','p4-desc':'ML models applied to real-world problems as part of certified training.',
      'e1-title':'Stagiaire Technicien Réseau & Systèmes','e1-date':'2022 · Academic internship','e1-desc':'Configuration and maintenance of telecom networks, Linux administration, IT infrastructure support.',
      'e2-title':'Freelance Web Developer','e2-company':'Self-employed · Madagascar','e2-date':'2021 — present','e2-desc':'Design and development of websites and apps for local clients. 14 projects completed.',
      'e3-title':'IT Technician','e3-company':'Service provider · Antananarivo','e3-date':'2020 — present','e3-desc':'Installation, configuration and troubleshooting of computer equipment and local networks.',
      'f1-title':'Master 2 — Telecommunications Engineering','f1-desc':'Networks, embedded systems, cybersecurity and data analytics.',
      'f2-title':'Licence — Télécommunications & Informatique','f2-desc':'Telecommunications, computer networks, programming and operating systems.',
      'f3-title':'Scientific Baccalaureate — Series C','f3-desc':'Scientific baccalaureate with distinction.',
      'v1-title':'Volunteer Trainer — Computer Initiation','v1-co':'Association Jeunesse & Numérique · Antananarivo','v1-date':'2022 — present','v1-desc':'Leading computer initiation workshops for underprivileged youth.',
      'v2-title':'Active Member — ESPA Computer Club','v2-co':'ESPA — École Supérieure Polytechnique','v2-date':'2020 — 2024','v2-desc':'Organizing tech events, hackathons and knowledge-sharing sessions among students.',
      'v3-title':'Mentor — Student Projects','v3-co':'ESPA alumni network','v3-date':'2023 — present','v3-desc':'Supporting junior students with their final year projects.',
      'ac-title':'Connexions rapides','bt-lbl':'Activé','flight-lbl':'Mode avion','flight-st':'Désactivé','dnd-lbl':'Ne pas déranger','dnd-st':'Désactivé','eco-lbl':'Économiseur','eco-st':'Désactivé','disp-lbl':'Affichage','disp-st':'Activé','ac-batt-txt':'71% — Plugged in · ~5h remaining',
      'notif-title-el':'Notifications','notif-clear-el':'Tout effacer',
      'sm-pinned-title_inner':'Épinglées','sm-seeall':'Tout voir ›','sm-rec-title':'Recommandés','sm-shortcuts-title':'Raccourcis','sm-recent-title':'Activité récente','sm-sys-title':'Système','sm-batt-txt':'🔋 71% · Plugged in',
      'papp-skills':'Compétences','papp-projects':'Projets','papp-exp':'Expérience','papp-form':'Formation','papp-vol':'Volontariat',
      'ql-exp':'Expérience','ql-form':'Formation','ql-vol':'Volontariat','rec3-time':'5 min ago',
      'set-sys-lbl':'Système','set-perso-lbl':'Personnalisation','set-bright-lbl':'Luminosité','set-lang-lbl':'Langue','set-lang-val':'Français','set-wifi-lbl':'Wi-Fi','set-wifi-txt':'Tantely_5G — Connected','set-acct-lbl':'Compte local',
      'contact-direct-lbl':'Message direct','f-lbl-name':'Nom *','f-lbl-subj':'Sujet','f-lbl-msg':'Message *',
      'lout-msg':'What would you like to do?','btn-cancel-lbl':'Annuler','btn-logout-lbl':'Se déconnecter',
      'pm-lock-lbl':'Verrouiller','pm-sleep-lbl':'Veille','pm-shut-lbl':'Arrêter','pm-rest-lbl':'Redémarrer','pm-logo-lbl':'Déconnexion',
      'batt-status':'Plugged in · ~5h remaining','batt-note':'Battery saver is off',
    }
  }
  const d=T[lang]||T.en
